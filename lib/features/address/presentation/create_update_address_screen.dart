...
class CreateUpdateAddressScreen extends ConsumerWidget {
  ...
  const CreateUpdateAddressScreen({super.key, required this.addressId});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AsyncValueWidget<AddressModelDto?>(
      value: addressValue,
      data:
          (address) => CreateUpdateAddressContents(
            addressId: addressId,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ResponsiveScrollable(
        child: FocusScope(
          node: _node,
          child: AddressForm(address: widget.address, onSaved: _submit),
        ),
      ),
    );
  }
