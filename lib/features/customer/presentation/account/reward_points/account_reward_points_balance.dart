...
class RewardPointsBalance extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (rewardPoints.rewardPointsAmount != null) {
      ...
      rewardPointsAmountBeforeDot = rewardPoints.rewardPointsAmount!.substring(
        0,
        amountDotIndex,
      );
      rewardPointsAmountAfterDot = rewardPoints.rewardPointsAmount!.substring(
        amountDotIndex,
      );
    }
    ...
    return Row(
      ...
      children: [
        ...
        const Center(child: FaIcon(FontAwesomeIcons.equals, color: Colors.white,)),
        Column(
          crossAxisAlignment: CrossAxisAlignment.end,
          children: [
            Row(
                  ...
                  children: [
                    ...
                    if (rewardPointsAmountAfterDot.isNotEmpty)
                      Text(
                        ...
                        style: Theme.of(
                          context,
                        ).textTheme.titleMedium!.copyWith(color: moneyColor),
                      ),
                  ],
                )
                : Text(
