...
class ReturnRequestCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final items = <Widget>[
      Row(
        ...
        children: [
          Text(
            context.locale!.account_return_request_number.format([
              ...
              onTap:
                  () => {
                    context.pushNamed(
                      Routes.product.name,
                      pathParameters: {
                        'id': returnRequest.productId.toString(),
                      },
                    ),
                  },
  ...
  Widget printReturnRequestStatus(returnRequestStatus, labelStyle) {
    ...
    return ActionChip(
      label: Text(returnRequestStatus, style: labelStyle),
