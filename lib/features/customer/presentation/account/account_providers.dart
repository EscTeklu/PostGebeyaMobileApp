...
final accountControllerProvider =
    StateNotifierProvider.autoDispose<AccountController, BaseNopState>((ref) {
...
final changePasswordControllerProvider =
    StateNotifierProvider.autoDispose<ChangePasswordController, BaseNopState>(
        (ref) {
...
final contactUsControllerProvider =
    StateNotifierProvider.autoDispose<ContactUsController, BaseNopState>((ref) {
  return ContactUsController(
      commonRepository: ref.watch(commonRepositoryProvider));
});

final customerInfControllerProvider =
    StateNotifierProvider.autoDispose<CustomerInfoController, BaseNopState>(
        (ref) {
...
final customerInfoProvider =
    FutureProvider.autoDispose<CustomerInfoModelDto>((ref) async {
...
final customerAddressesProvider =
    FutureProvider.autoDispose<CustomerAddressListModelDto>((ref) async {
  final customerRepository =
      ref.watch(getRepositoryProvider(() => CustomerRepository()));
...
final customerOrdersProvider =
    FutureProvider.autoDispose<CustomerOrderListModelDto>((ref) async {
  final customerRepository =
      ref.watch(getRepositoryProvider(() => CustomerRepository()));
  return await customerRepository.getCurrentCustomerOrders();
});

final customerReturnRequestsProvider =
    FutureProvider.autoDispose<CustomerReturnRequestsModelDto>((ref) async {
  final returnRequestsRepository =
      ref.watch(getRepositoryProvider(() => ReturnRequestRepository()));
  return await returnRequestsRepository.customerReturnRequests();
});

final customerDownloadableProductsProvider =
    FutureProvider.autoDispose<CustomerDownloadableProductsModelDto>(
        (ref) async {
  final customerRepository =
      ref.watch(getRepositoryProvider(() => CustomerRepository()));
...
final customerBackInStockProvider =
    FutureProvider.autoDispose<CustomerBackInStockSubscriptionsModelDto>(
        (ref) async {
  final customerRepository =
      ref.watch(getRepositoryProvider(() => CustomerRepository()));
...
final customerBackInStockControllerProvider = StateNotifierProvider.autoDispose<
    CustomerBackInStockController, BaseNopState>((ref) {
  return CustomerBackInStockController(
      customerRepository:
          ref.watch(getRepositoryProvider(() => CustomerRepository())));
});

final customerRewardPointsProvider = FutureProvider.autoDispose
    .family<CustomerRewardPointsModelDto, int?>((ref, pageNumber) async {
  final customerRepository =
      ref.watch(getRepositoryProvider(() => CustomerRepository()));
  return await customerRepository.getCurrentCustomerRewardPoints(pageNumber);
});

final customerAvatarProvider =
    FutureProvider.autoDispose<CustomerAvatarModelDto>((ref) async {
  final customerRepository =
      ref.watch(getRepositoryProvider(() => CustomerRepository()));
...
final gdprToolsControllerProvider =
    StateNotifierProvider.autoDispose<GdprToolsController, BaseNopState>((ref) {
...
final gdprToolsProvider =
    FutureProvider.autoDispose<GdprToolsModelDto?>((ref) async {
  final gdprToolsRepository =
      ref.watch(getRepositoryProvider(() => GdprToolsRepository()));
...
final wishlistProvider =
    FutureProvider.autoDispose<WishlistModelDto?>((ref) async {
  final controller = ref.read(wishlistControllerProvider.notifier);
  return controller.getWishlist();
});

final wishlistControllerProvider =
    StateNotifierProvider<WishlistController, AsyncValue<Wishlist>>((ref) {
...
final downloadControllerProvider =
    StateNotifierProvider.autoDispose<DownloadController, BaseNopState>((ref) {
