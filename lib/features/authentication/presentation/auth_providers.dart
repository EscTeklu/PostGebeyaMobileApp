...
final authStateChangesProvider =
    StreamProvider.autoDispose<NopCustomer?>((ref) {
  final authRepository = ref.watch(authRepositoryProvider);
  return authRepository.authStateChanges();
});

final loginControllerProvider =
    StateNotifierProvider.autoDispose<LoginController, BaseNopState>((ref) {
  return LoginController(
      authenticationService: ref.watch(authenticationServiceProvider));
});

final registerInfoProvider =
    FutureProvider.autoDispose<RegisterModelDto?>((ref) async {
