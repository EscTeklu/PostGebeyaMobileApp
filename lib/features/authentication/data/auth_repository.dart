...
class AuthenticateRepository extends BaseRepository {
  ...
  Future<String?> getWebApiVersion() async {
    final api = await WebApiHelper.getApi(
        (frontendApi) => frontendApi.getAuthenticateApi());
  ...
  Future<bool> login({String? email, String? password}) async {
    ...
    final response = await api.apiFrontendCustomerLoginPost(
        loginCustomerRequest: authenticateRequest);
  ...
  Future<String?> recover({String? email}) async {
    ...
    final response = await api.apiFrontendCustomerPasswordRecoverySendPost(
        passwordRecoveryModelDto: builder.build());
