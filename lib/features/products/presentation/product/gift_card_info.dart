                ...
                Padding(
                  ...
                  child: Focus(
                    child: TextFormField(
                      ...
                      autofocus: false,
                      onChanged: (value) => {giftCard?.recipientName = value},
                      ...
                      decoration: InputDecoration(
                        labelText:
                            context
                                .locale!
                                .product_gift_card_info_recipient_name,
                      ),
                    ),
                ...
                Padding(
                  ...
                  child: Focus(
                    child: TextFormField(
                      ...
                      autofocus: false,
                      onChanged: (value) => {giftCard?.recipientEmail = value},
                      ...
                      decoration: InputDecoration(
                        labelText:
                            context
                                .locale!
                                .product_gift_card_info_recipient_email,
                      ),
                    ),
                    onFocusChange: (hasFocus) {
                      if (!hasFocus) {
                ...
                Padding(
                  ...
                  child: Focus(
                    child: TextFormField(
                      keyboardType: TextInputType.name,
                      autofocus: false,
                      onChanged: (value) => {giftCard?.senderName = value},
                ...
                Padding(
                  ...
                  child: Focus(
                    child: TextFormField(
                      keyboardType: TextInputType.emailAddress,
                      autofocus: false,
                      onChanged: (value) => {giftCard?.senderEmail = value},
                ...
                Padding(
                  ...
                  child: Focus(
                    child: TextFormField(
                      ...
                      minLines: 1,
                      autofocus: false,
                      onChanged: (value) => {giftCard?.message = value},
