...
class AppTheme {
  ...
  static ColorScheme lightColorScheme = const ColorScheme(
    ...
    surfaceContainerHighest: StyleDictionary.mdSysColorSurfaceVariantLight,
  ...
  static ColorScheme darkColorScheme = const ColorScheme(
    ...
    surfaceContainerHighest: StyleDictionary.mdSysColorSurfaceVariantDark,
    ...
    return base.copyWith(
      extensions: <ThemeExtension<dynamic>>[
        CustomColors(
          ...
          ratingStarColor: colorScheme.onSurface,
          pictureIndicatorColor: colorScheme.onSurface,
          pictureIndicatorCurrentColor: colorScheme.surface,
      ...
      switchTheme: SwitchThemeData(
        overlayColor: WidgetStateProperty.all<Color>(colorScheme.primary),
      ).copyWith(
