          ...
          if (usePickupPoint)
            Padding(
              ...
              child: AsyncValueWidget<CheckoutShippingAddressModelDto?>(
                ...
                data:
                    (response) => PickupPointsFormContents(
                  onStepContinue: widget.onStepContinue,
                  pickupPoints:
                  (response?.pickupPointsModel ??
          ...
          if (!usePickupPoint) ...[
            if (!widget.useBillingAddressAsShippingAddress)
              Padding(
                ...
                child: AsyncValueWidget<CheckoutShippingAddressModelDto?>(
                  value: shippingAddressData,
                  data:
                      (addresses) => ShippingFormContents(
                    addresses:
                    (addresses ?? CheckoutShippingAddressModelDto())
                        .toBuilder(),
                  ),
                ),
              ),
            Padding(
              ...
              child: AsyncValueWidget<ShippingMethodResponse?>(
                ...
                data:
                    (response) => ShippingMethodsFormContents(
                  onStepContinue: widget.onStepContinue,
