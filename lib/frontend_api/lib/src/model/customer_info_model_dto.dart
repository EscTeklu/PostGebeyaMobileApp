...
part 'customer_info_model_dto.g.dart';
...
/// * [customProperties] 
@BuiltValue()
abstract class CustomerInfoModelDto implements Built<CustomerInfoModelDto, CustomerInfoModelDtoBuilder> {
  ...
  @BuiltValueField(wireName: r'signature_enabled')
  bool? get signatureEnabled;
  ...
  CustomerInfoModelDto._();

  factory CustomerInfoModelDto([void updates(CustomerInfoModelDtoBuilder b)]) = _$CustomerInfoModelDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CustomerInfoModelDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CustomerInfoModelDto> get serializer => _$CustomerInfoModelDtoSerializer();
}

class _$CustomerInfoModelDtoSerializer implements PrimitiveSerializer<CustomerInfoModelDto> {
  @override
  final Iterable<Type> types = const [CustomerInfoModelDto, _$CustomerInfoModelDto];

  @override
  final String wireName = r'CustomerInfoModelDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CustomerInfoModelDto object, {
    ...
    if (object.signatureEnabled != null) {
      yield r'signature_enabled';
      yield serializers.serialize(
        object.signatureEnabled,
        specifiedType: const FullType(bool),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required CustomerInfoModelDtoBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'newsletter':
          ...
          break;
        case r'signature_enabled':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool;
          result.signatureEnabled = valueDes;
          break;
        case r'signature':
          final valueDes = serializers.deserialize(
            value,
  ...
  @override
  CustomerInfoModelDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CustomerInfoModelDtoBuilder();
