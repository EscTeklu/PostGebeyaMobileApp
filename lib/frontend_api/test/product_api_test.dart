...
void main() {
  ...
  group(ProductApi, () {
    ...
    //
    //Future<SetProductReviewHelpfulnessResponse> apiFrontendProductSetProductReviewHelpfulnessProductReviewIdPost(int productReviewId, bool helpfulness) async
