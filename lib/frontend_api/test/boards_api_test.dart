...
void main() {
  ...
  group(BoardsApi, () {
    ...
    //
    //Future<CustomerForumSubscriptionsModelDto> apiFrontendBoardsCustomerForumSubscriptionsPost({ BuiltMap<String, String> requestBody }) async
    test('test apiFrontendBoardsCustomerForumSubscriptionsPost', () async {
      // TODO
    });
