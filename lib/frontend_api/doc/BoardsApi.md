...
[**apiFrontendBoardsCustomerForumSubscriptionsPost**](BoardsApi.md#apifrontendboardscustomerforumsubscriptionspost) | **POST** /api-frontend/Boards/CustomerForumSubscriptions | Customer forum subscriptions POST
...
# **apiFrontendBoardsCustomerForumSubscriptionsPost**
> CustomerForumSubscriptionsModelDto apiFrontendBoardsCustomerForumSubscriptionsPost(requestBody)
...
try {
    final response = api.apiFrontendBoardsCustomerForumSubscriptionsPost(requestBody);
    print(response);
} catch on DioException (e) {
    print('Exception when calling BoardsApi->apiFrontendBoardsCustomerForumSubscriptionsPost: $e\n');
}
```
