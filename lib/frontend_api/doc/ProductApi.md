...
> SetProductReviewHelpfulnessResponse apiFrontendProductSetProductReviewHelpfulnessProductReviewIdPost(productReviewId, helpfulness)
...
final bool helpfulness = true; // bool | Indicator if the review was helpful

try {
    final response = api.apiFrontendProductSetProductReviewHelpfulnessProductReviewIdPost(productReviewId, helpfulness);
    print(response);
} catch on DioException (e) {
 ...
 **helpfulness** | **bool**| Indicator if the review was helpful | 
